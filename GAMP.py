...
class GAMP:
    ...
    def forward(self, y, H_funcs, noise_sigma, x_t,
        ...
        # Get the device of the input (GPU/CPU)
        device = y.device
        dtype = y.dtype
        ...
        # Reuse buffer - ensure device consistency
        ...
        # Ensure noise_sigma is on the correct device
    ...
    def awgn_likelihood_cs(p: Tensor, tau_p: Tensor,
        ...
        # Ensure constants are also on GPU (via p's device property)
